  ...
  <div class="root">
    ...
    <div class="header">
      <div class="top">
        <div class="toolbar">
          <span>
            <div class="circle" title="新建项目" @click="startAddProject()">
              <i class="fa  fa-plus fa-fw i_label"></i>
            </div>
          </span>
          <span>
            <div class="circle" title="搜索项目" @click="startSearchProject()">
              <i class="fa  fa-search fa-fw i_label"></i>
            </div>
          </span>
          <el-dropdown trigger="click">
            <div class="circle">
              <i class="fa  fa-user fa-fw i_label"></i>
            </div>
            <el-dropdown-menu slot="dropdown" trigger="click">
              <el-dropdown-item><i class="fa fa-user fa-fw"></i>&nbsp;{{nickname}}</el-dropdown-item>
                <el-dropdown-item ><i class="fa fa-envelope-o fa-fw"></i>&nbsp;{{email}}</el-dropdown-item>
              <el-dropdown-item :divided="true"><i class="fa fa-cog fa-fw"></i>&nbsp;账户修改</el-dropdown-item>
